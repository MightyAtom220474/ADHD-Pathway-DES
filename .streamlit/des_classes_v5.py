...
class g:
    ...
    triage_waiting_list = 1000 # Current number of patients on waiting list for Triage
    ...
    mdt_waiting_list = 1200 # current number of patients on waiting list for MDT
...
class Model:
    ...
    def generator_patient_referrals(self):
        ...
        if g.debug_level >= 1:
            print(f'Week {self.week_number}: {sampled_referrals
                                                        } referrals generated')
            print('')
            print(f'Still remaining on triage WL from last week: {
                                                        g.number_on_triage_wl}')

            print('')
            print(f'Still remaining on mdt WL from last week: {
                                                        g.number_on_mdt_wl}')

            print('')
            print(f'Still remaining on Assessment WL from last week: {
                                                        g.number_on_asst_wl}')
            print("----------------")
    ...
    # generator function that represents the triage part of the pathway
